...
import { formatCurrency, formatDate, colorForIndex, formatCompactINR } from "../utils/format";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-5">
          <h2 className="text-sm font-semibold mb-3">Monthly Expenses by Category</h2>
        ...
        <div className="card p-5">
          ...
          {deposits.length === 0 ? (
            <div className="py-12 text-center text-sm text-ink-muted">No income recorded yet</div>
          ) : (
